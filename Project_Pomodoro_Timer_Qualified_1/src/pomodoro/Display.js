...
function Display(props) {
  ...
  //   focus: true
  // }
  const {currentState,timeSeconds}=props;
  ...
  return (
    ...
    <div className="row mb-2">
      <div className="col">
        ...
        <h2 data-testid="session-title">{focus?"Focusing":"Breaking"} for {focus?timeSeconds(focusDuration):timeSeconds(focusDuration)} minutes</h2>
